...
class TerminalAdminController
{
    ...
    public function index(): void
    {
        ...
        // Bereichsnamen. Gebraucht werden sie für die Quick-Toggle-POSTs.
        ...
        require __DIR__ . '/../views/terminal_admin/liste.php';
    }
    ...
    public function speichern(): void
    {
        ...
        if (!Csrf::istGueltig(self::CSRF_BEREICH)) {
            ...
            $this->renderFormular($this->leseTerminalAusPost(), $this->abteilungModel->holeAlleAktiven(), $fehlermeldung);
            return;
        }
     ...
     */
    private function renderFormular(array $terminal, array $abteilungen, ?string $fehlermeldung): void
    {
        ...
        require __DIR__ . '/../views/terminal_admin/formular.php';
    }
}
