-- Migration: 21 - Stundenkonto (Batch + Korrektur) + Recht STUNDENKONTO_VERWALTEN
-- Datum: 2026-01-17
--
-- Zweck:
...
-- - Es existiert zusaetzlich `sql/13_migration_stundenkonto.sql` als Legacy-Alias (gleicher Inhalt),
--   falls ein alter Patch schon ausgerollt wurde. Kanonisch ist diese Datei (21).
