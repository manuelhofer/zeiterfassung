# Master-Prompt v10 – Projekt „Zeiterfassung und Mitarbeiter-/Auftragsmanagement“

*Version:* v10 (2026-01-11)
...
- Der Master-Prompt selbst (`docs/master_prompt_zeiterfassung_v10.md`) ist ebenfalls immer in der ZIP enthalten und wird angepasst, wenn sich Meta-Regeln (wie diese) verändern.
