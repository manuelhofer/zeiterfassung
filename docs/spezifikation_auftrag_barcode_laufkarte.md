...
3. Für Auftrag und jeden Arbeitsschritt gibt es einen **QR-Code**.
4. Alles zusammen lässt sich als **Laufkarte** (PDF) ausdrucken und dem
   Werkstück beilegen. Der Mitarbeiter scannt am Terminal vom Papier: erst den
...
Formularfeld. Damit funktionieren die gedruckten Codes **ohne jede Änderung am
...
jederzeit reproduzierbar und werden bei Bedarf erzeugt; ein zusätzliches
Pfad-Feld wäre nur eine weitere Stelle, die aus dem Tritt geraten kann.
...
- Danach je Arbeitsschritt ein Block: laufende Nummer, Code, Bezeichnung,
  ...
  Menge) – es ist eine Laufkarte für die Werkstatt.
...
### Warum das ohne Terminal-Änderung funktioniert
...
wo der Code nur pro Auftrag eindeutig sein muss. Ein an der Maschine hängender
