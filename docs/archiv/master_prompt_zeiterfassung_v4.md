# Master-Prompt v3 – Projekt „Zeiterfassung und Mitarbeiter-/Auftragsmanagement“

*Version:* v3 (2025-12-25)
...
8. **Pre-Flight Gate gegen Doppelarbeit (Pflicht)**
   ...
   - **Bevor irgendeine Änderung am Code/SQL geplant oder umgesetzt wird, MUSS folgendes passieren:**
     1. **Inputs prüfen (Source of Truth):**
        ...
        - `docs/master_prompt_zeiterfassung_v3.md`,
...
- Backend-Funktionen:
  ...
  - Einfluss auf Sollstunden-Berechnung.
...
- Der Master-Prompt selbst (`docs/master_prompt_zeiterfassung_v3.md`) ist ebenfalls immer in der ZIP enthalten und wird angepasst, wenn sich Meta-Regeln (wie diese) verändern.

---

# v4 Ergänzungen (verbindlich, Stand 2026-01-01)
