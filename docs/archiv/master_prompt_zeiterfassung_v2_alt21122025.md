# Master-Prompt – Projekt „Zeiterfassung und Mitarbeiter-/Auftragsmanagement“
...
6. **DEV_PROMPT_HISTORY – Pflichtformat & Aktualisierung**
...
- Der Master-Prompt selbst (`docs/master_prompt_zeiterfassung_v2.md`) ist ebenfalls immer in der ZIP enthalten und wird angepasst, wenn sich Meta-Regeln (wie diese) verändern.
