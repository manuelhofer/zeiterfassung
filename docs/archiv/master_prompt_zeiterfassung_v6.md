# Master-Prompt v6 – Projekt „Zeiterfassung und Mitarbeiter-/Auftragsmanagement“

*Version:* v6 (2026-01-03)
...
- Der Master-Prompt selbst (`docs/master_prompt_zeiterfassung_v6.md`) ist ebenfalls immer in der ZIP enthalten und wird angepasst, wenn sich Meta-Regeln (wie diese) verändern.
...
# v6 Ergänzungen (verbindlich, Stand 2026-01-03)

Diese v6-Ergänzungen präzisieren das System so, dass es **sauber skaliert** und der Chef im Backend alles sinnvoll einstellen kann.
