# Master-Prompt v7 – Projekt „Zeiterfassung und Mitarbeiter-/Auftragsmanagement“

*Version:* v7 (2026-01-05)
...
8. **Pre-Flight Gate gegen Doppelarbeit (Pflicht)**
   ...
   - **Bevor irgendeine Änderung am Code/SQL geplant oder umgesetzt wird, MUSS folgendes passieren:**
     1. **Inputs prüfen (Source of Truth):**
        ...
        - `docs/master_prompt_zeiterfassung_v7.md`,
...
### 8.X Terminal/Kiosk: Layout, Uhr & Texte (verbindlich ab v7)
...
- Der Master-Prompt selbst (`docs/master_prompt_zeiterfassung_v7.md`) ist ebenfalls immer in der ZIP enthalten und wird angepasst, wenn sich Meta-Regeln (wie diese) verändern.
